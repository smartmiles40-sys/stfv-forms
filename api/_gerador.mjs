...
function gerarHtml(spec) {
  ...
  p("");
  p("  // CAMPO-ARMADILHA. Gente nao ve (fora da tela, fora da ordem de tabulacao,");
  p("  // escondido de leitor de tela); robo de formulario preenche tudo o que");
  p("  // encontra. O servidor descarta o envio que vier com ele preenchido, e");
  p('  // responde como se tivesse dado certo \u2014 dizer "peguei voce" so ensina qual');
  p("  // campo entregou o robo.");
  p("  //");
  p("  // Vive FORA do raiz de proposito: o render() reescreve o raiz a cada etapa,");
  p("  // e o campo tem que sobreviver as tres.");
  p("  var armadilha = document.createElement('input');");
  p("  armadilha.type = 'text';");
  p("  armadilha.name = 'site';");
  p("  armadilha.tabIndex = -1;");
  p("  armadilha.autocomplete = 'off';");
  p("  armadilha.setAttribute('aria-hidden', 'true');");
  p("  armadilha.style.cssText = 'position:absolute;left:-9999px;top:auto;width:1px;height:1px;opacity:0';");
  p("  document.body.appendChild(armadilha);");
  ...
  p("    payload.site = armadilha.value || '';");
